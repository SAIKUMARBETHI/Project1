...
import Opencart.Pages.Opencart_Specialspage;
...
public class Opencart_Specialssd extends Opencart_Basepage {
	Opencart_Specialspage special;
	final static Logger logger=LogManager.getLogger(Opencart_Specialssd.class.getName());
	 @Given("^the user to open browser chrome$")
	    ...
	    public void the_user_close_the_site_and_browser() throws Throwable {
			...
			util.takeSnapShot("E:\\javas\\Demo.OpenCart\\src\\test\\resources\\screenshot\\specialPage.png");
